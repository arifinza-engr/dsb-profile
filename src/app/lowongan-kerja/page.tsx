...
import { Briefcase, MapPin, Clock, DollarSign, Users, Star, ArrowRight } from "lucide-react";
...
export default function LowonganKerjaPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <HeroSection
        title="Lowongan Kerja ABK Profesional"
        subtitle="Bergabunglah dengan Armada Global"
        description="Temukan peluang karir di industri maritim internasional dengan kompensasi kompetitif, kontrak jangka panjang, dan pengembangan karir yang berkelanjutan"
        ctaText="Daftar Sekarang"
        ctaHref="/contact"
        secondaryCtaText="Pelajari Persyaratan"
        ...
        <div className="container-maritime">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Lowongan kerja dengan prioritas tinggi untuk posisi strategis di kapal
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {featuredJobs.map((job) => (
              <div key={job.id} className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 border border-blue-100 dark:border-slate-700 hover:shadow-xl transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-foreground mb-2">{job.title}</h3>
                    <p className="text-blue-600 dark:text-blue-400 font-medium">{job.department}</p>
                  </div>
                  <div className="bg-yellow-100 dark:bg-yellow-900/30 px-3 py-1 rounded-full">
                    ...
                    <span className="text-sm font-medium text-yellow-700 dark:text-yellow-300">Featured</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-300">{job.duration}</span>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-foreground mb-3">Benefit:</h4>
                  <ul className="space-y-1">
      ...
      <section className="py-20 bg-white dark:bg-slate-900">
        <div className="container-maritime">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {regularJobs.map((job) => (
              <div key={job.id} className="bg-gray-50 dark:bg-slate-800 rounded-lg p-6 border border-gray-200 dark:border-slate-700 hover:shadow-md transition-shadow">
                <div className="mb-4">
                ...
                <div className="mb-4">
                  <h4 className="font-semibold text-foreground mb-2 text-sm">Persyaratan Utama:</h4>
                  <ul className="space-y-1">
                    ...
                    {job.requirements.length > 2 && (
                      <li className="text-xs text-gray-500">+{job.requirements.length - 2} lainnya</li>
                    )}
                  </ul>
                </div>
      ...
      <section id="requirements" className="py-20 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-900">
        <div className="container-maritime">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">
              Persyaratan Umum
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Kualifikasi dasar yang harus dipenuhi untuk bergabung dengan armada maritim
            </p>
            <div className="w-24 h-1 bg-gradient-to-r from-primary to-blue-400 mx-auto rounded-full mt-4" />
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg p-6 text-center shadow-md">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Pendidikan</h3>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg p-6 text-center shadow-md">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Kesehatan</h3>
              <p className="text-gray-600 dark:text-gray-300">Medical fitness</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg p-6 text-center shadow-md">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Pengalaman</h3>
              <p className="text-gray-600 dark:text-gray-300">Bervariasi per posisi</p>
            </div>
          </div>

          <div className="text-center mt-12">
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Siap memulai karir maritim Anda? Hubungi kami untuk informasi lebih lanjut.
            </p>
            <a
              href="/contact"
